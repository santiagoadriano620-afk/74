...
-- Honey Flower
keywordHandler:addKeyword({ "honey", "flower" }, StdModule.say, { npcHandler = npcHandler, text = "Oh, thank you so much! Please take this piece of armor as reward." }, function(player)
