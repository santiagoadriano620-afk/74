...
cookiKeyword:addChildKeyword({ "yes" }, StdModule.say, { npcHandler = npcHandler, text = "Fine! Here's your gold.", reset = true }, function(player)
...
blueberryKeyword:addChildKeyword({ "yes" }, StdModule.say, { npcHandler = npcHandler, text = "Fine! Here's your gold.", reset = true }, function(player)
