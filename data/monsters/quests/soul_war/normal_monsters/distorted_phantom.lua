...
monster.attacks = {
	...
	{ name = "ice chain", interval = 10000, chance = 59, minDamage = -1100, maxDamage = -1300, range = 3 },
	...
	{ name = "extended holy chain", interval = 15000, chance = 30, minDamage = -400, maxDamage = -700, range = 4 },
}
