...
monster.attacks = {
	...
	{ name = "extended energy chain", interval = 2000, chance = 15, minDamage = -500, maxDamage = -600, range = 3 },
	...
	{ name = "extended holy chain", interval = 2000, chance = 15, minDamage = -1030, maxDamage = -1250, range = 4 },
}
