...
monster.attacks = {
	...
	-- fire
	{ name = "condition", interval = 100, chance = 7, target = false, condition =
	{ type = CONDITION_FIRE, minDamage = -200, maxDamage = -1000, range = 2, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_BLOCKHIT } },
